...
export const heroData = {
  pitch: "Over the past <strong>13 years</strong>, I've transformed complex data challenges into high-impact business solutions that drive real results. My journey has taken me from hands-on analyst work to leading data teams, architecting <strong>scalable data ecosystems</strong>, and pioneering <strong>AI-driven automation</strong> that delivers game-changing efficiency gains—like reducing manual development time by <strong>90%</strong> through Agentic AI workflows. Along the way, I've generated <strong>$2.3MM+ in annual value</strong>, <strong>saved 50+ FTE positions</strong> through intelligent automation, and <strong>slashed critical data access times from weeks to under an hour</strong>. I'm not just building dashboards and pipelines—I'm creating data-driven decision engines that empower organizations to move faster, scale smarter, and achieve measurable growth. As a <strong>T-shaped professional</strong>, I bring deep expertise in data engineering and BI, complemented by hands-on experience in AI/ML, quantitative finance, product management, and full-stack development.",
  philosophy: "My approach is grounded in four core principles that guide everything I build: <strong>T-Shaped Learning & Rapid AI Mastery</strong>—I maintain deep vertical expertise in data and BI while continuously expanding across AI, trading, and product domains. My recent pivot to AI (Agentic workflows, GenAI chatbots, LLM automation) shows how I rapidly master new technologies through hands-on building, not just theory. <strong>Measurable Impact Over Activity</strong>—every solution I create must deliver quantifiable business value, whether that's FTE savings, dollar impact, or time reduction. I believe in results that can be measured and celebrated. <strong>Automation as a Strategic Advantage</strong>—if something is manual and repetitive, it should be automated; if it's automated but slow, it should be AI-powered. This mindset has driven my career-long focus on building tools that multiply human productivity. <strong>Data as a Decision Engine</strong>—raw data becomes powerful when it's transformed into actionable insights that empower everyone from executives making strategic calls to analysts executing daily work. I combine deep technical expertise with business acumen to build systems that don't just work—they scale, simplify, and drive measurable results that matter."
};
...
export const projectData: Project[] = [
    ...
    {
        title: "King Maker Salon - Bangalore",
        category: "Side Project",
        summary: "Launched and operated a premium unisex salon in Bangalore (2023-present), demonstrating entrepreneurial initiative and business management skills beyond traditional data/tech roles.",
        details: "<p><strong>Initiative:</strong> An entrepreneurial venture launched in 2023 to diversify beyond the tech industry and build hands-on business management experience. King Maker Salon is a premium unisex salon located in Bangalore, offering comprehensive hair care, styling, and grooming services to a diverse clientele.</p><p><strong>Business Approach:</strong> Identified a strategic location in Bangalore with high foot traffic and underserved demand for quality salon services. Established vendor relationships for professional-grade products and equipment, recruited and trained skilled stylists and beauticians, and implemented customer service standards to ensure consistent quality and client satisfaction. Developed pricing strategies competitive with local market while maintaining premium service positioning.</p><p><strong>Operations Management:</strong> Managed all aspects of salon operations including staff scheduling, inventory management for consumables and products, customer appointment booking systems, and financial accounting. Implemented basic marketing strategies leveraging local advertising, social media presence, and word-of-mouth referrals to build a loyal customer base.</p><p><strong>Key Learnings:</strong> This venture provided invaluable experience in small business management, customer-facing service delivery, team leadership in a non-technical domain, and financial management—skills that complement technical expertise with real-world business acumen. Demonstrated ability to succeed in entrepreneurial ventures outside comfort zone of data/tech, showing versatility, risk-taking capability, and commitment to building sustainable businesses.</p><p><strong>Current Status:</strong> The salon continues to operate successfully, serving regular clients and maintaining profitability while I manage it as a passive income stream alongside primary data engineering and leadership roles. This side venture showcases entrepreneurial mindset and ability to balance multiple professional commitments effectively.</p>",
        technologies: ["Business Management", "Operations", "Customer Service", "Team Leadership", "Financial Planning", "Marketing", "Entrepreneurship"]
    },
    {
