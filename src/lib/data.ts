...
export const heroData = {
  pitch: "I'm a proven data leader with <strong>13 years of experience</strong> transforming complex data challenges into high-impact business solutions. My work has driven <strong>$2.3MM+ in annual value</strong>, <strong>saved 30+ FTE positions</strong> through automation, and <strong>reduced critical data access times from weeks to hours</strong>. I don't just build dashboards—I architect <strong>scalable data ecosystems</strong>, pioneer <strong>AI-driven automation</strong> (like my 90% efficiency gain in dbt migration), and deliver solutions that directly impact revenue and strategic growth.",
  philosophy: "I believe in three core pillars: <strong>Measurable Impact Over Activity</strong>—every solution must deliver quantifiable business value; <strong>Automation as a Strategic Advantage</strong>—if it's manual and repetitive, it should be automated; and <strong>Data as a Decision Engine</strong>—transform raw data into actionable insights that empower teams from executives to analysts. I combine deep technical expertise with business acumen to build systems that scale, simplify, and drive results."
};
...
export const projectData: Project[] = [
    ...
    },
    {
        ...
        summary: "Developed a profitable quantitative trading operation managing ₹3 crore+ AUM with 20% CAGR, designing and deploying four proprietary time-based options strategies (50% CAGR) while mentoring 2 interns and 12 traders.",
        details: "<p><strong>Initiative:</strong> An entrepreneurial venture into quantitative finance, applying data science and disciplined execution to options markets. Managed over six derivative trading portfolios independently, demonstrating transferable skills in quantitative analysis, risk management, and strategic decision-making outside of corporate environments.</p><p><strong>Work Done:</strong> I independently researched, designed, rigorously back-tested, and deployed four novel time-based options strategies at 1-minute granularity scale. I managed the entire trading lifecycle—from data analysis and strategy formulation to risk management and execution—growing the combined AUM to over ₹3 crore. I recruited and trained 2 interns to execute trades and maintain detailed account records, while mentoring 2 paid mentees and 10 trial mentees on trading principles, technical analysis, and lean thinking methodologies.</p><p><strong>Impact:</strong> Achieved a consistent 20% CAGR across the overall portfolio and an exceptional 50% CAGR on the four proprietary strategies over multi-year periods, demonstrating strong quantitative analysis, disciplined risk management, and entrepreneurial capabilities. Successfully applied data-driven methodologies to identify market opportunities and manage portfolio risk in volatile, high-stakes environments.</p>",
        technologies: ["Quantitative Analysis", "Options Trading", "Risk Management", "Python", "Backtesting", "Technical Analysis"]
    },
];
